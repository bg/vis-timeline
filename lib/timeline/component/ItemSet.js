 ...
 */
   ...
   *                              Default is 20.
   *                           {number} margin.group
   *                              Margin between items and the group above.
   *                              Default is 0.
    ...
    if (options) {
      ...
      if ('margin' in options) {
        if (typeof options.margin === 'number') {
          ...
          this.options.margin.group = 0;
          this.options.margin.item.horizontal = options.margin;
          this.options.margin.item.vertical = options.margin;
        }
        else if (typeof options.margin === 'object') {
          util.selectiveExtend(['axis'], this.options.margin, options.margin);
          util.selectiveExtend(['group'], this.options.margin, options.margin);
  ...
  redraw() {
    ...
    let height = 0;
    const minHeight = margin.axis + margin.group + margin.item.vertical;
